...
$string['viz_gradecategoryaxis'] = '学年 × 科目カテゴリ';
$string['viz_categorygradeaxis'] = '科目カテゴリ × 学年';
$string['viz_categorymilestoneaxis'] = '科目カテゴリ × マイルストーン';
$string['viz_milestonecategoryaxis'] = 'マイルストーン × 科目カテゴリ';
