...
$string['viz_gradecategoryaxis'] = 'Grade × Subject category';
$string['viz_categorygradeaxis'] = 'Subject category × Grade';
$string['viz_categorymilestoneaxis'] = 'Subject category × Milestone';
$string['viz_milestonecategoryaxis'] = 'Milestone × Subject category';
